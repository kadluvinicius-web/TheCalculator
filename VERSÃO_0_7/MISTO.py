...
def Misto():
    ...
    for pergunta in range(questões):
        ...
        while True:
            try:
                if sinal != '√':
                    resultado = str(input(f"Questão {pergunta+1}) {número1} {sinal} {número2} = "))
                else:
                    resultado = str(input(f"Questão {pergunta + 1}) {sinal}{número2} = "))
    ...
    for questão in range(questões):
        ...
        if sinal == '+':
            ...
            if lista_número1[questão] - lista_número2[questão] == lista_resultado[questão]:
                ...
                print(
                    f"Questão {questão + 1}) \033[91mResposta errada!\033[94m A resposta correta é {lista_número1[questão] - lista_número2[questão]}\033[m")
                questões_erradas += 1
            questões_respondidas += 1
            ...
            if lista_resultado[questão] == math.sqrt(lista_número2[questão]):
                print(f"Questão {questão + 1}) \033[92mResposta correta!\033[m")
                questões_acertadas += 1
            else:
                print(f"Questão {questão + 1}) \033[91mResposta errada!\033[94m A resposta correta é {lista_número1[questão]}\033[m")
                questões_erradas += 1
            questões_respondidas += 1
